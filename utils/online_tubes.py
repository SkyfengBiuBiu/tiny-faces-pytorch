...
#                print("last_boxes_lps",last_boxes_lps)
                ...
                for lp in range(lp_count):
                    ...
                    if live_paths_last_found[lp] < self.jumpgap:
                        ...
                        if box_to_lp_score.sum()>0: # check if there's at least one box match
                            ...
                            #print("frames_boxes",frames_boxes.size())
#                            print("live_paths_boxes[lp]",live_paths_boxes[lp].size())
#                            print("frames_boxes[t0][max_ind,:]]",frames_boxes[t0][max_ind,:].size())
